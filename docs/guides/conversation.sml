---
id: 01KYP2JYBYK633CRHJFPMTV7FV
title: "Strata 設計対話ログ"
alias: conversation
---

# Strata 設計対話ログ {#01KYP2JYBYK633CRHJFPMTV7FW}

[id=01KYP2JYBYK633CRHJFPMTV7FX]
新しい文書フォーマット「Strata」を設計した対話の時系列記録。

---

## 1. 問題提起 {#01KYP2JYBYK633CRHJFPMTV7FY}

[id=01KYP2JYBYK633CRHJFPMTV7FZ]
...
## 2. 複雑さの厳密化(選択: 複雑さの定義を厳密化する) {#01KYP2JYBYK633CRHJFPMTV7G1}

[id=01KYP2JYBYK633CRHJFPMTV7G2]
複雑さを次元に分解:
[id=01KYP2JYBYK633CRHJFPMTV7G3]
- 軸1 参照構造(線形 / 木 / DAG / 一般グラフ) {#01KYP2JYBYK633CRHJFPMTV7G4}
- 軸2 局所表記(プレーン / 装飾 / 再帰木 / 入れ子コンテナ) {#01KYP2JYBYK633CRHJFPMTV7G5}
- 軸3 レイアウト束ね(結合セルは意味か装飾か = 情報欠損) {#01KYP2JYBYK633CRHJFPMTV7G6}
- 軸4 文脈依存(指示語・スコープ) {#01KYP2JYBYK633CRHJFPMTV7G7}

[id=01KYP2JYBYK633CRHJFPMTV7G8]
各次元に「機械可読」と「人へ戻す」を当てて要件を導出。可換性(往復で意味が保存されるか)。レイアウト束ねと文脈依存は不可逆になりやすい。

## 3. 組版・画像の追加(問い: 見栄えや image の扱いは?) {#01KYP2JYBYK633CRHJFPMTV7G9}

[id=01KYP2JYBYK633CRHJFPMTV7GA]
第5・第6の軸を追加:
[id=01KYP2JYBYK633CRHJFPMTV7GB]
- 軸5 連続実体(画像): 意味が画素にある写真 / 記号にある図。記号を画素に焼くのは意味欠損。 {#01KYP2JYBYK633CRHJFPMTV7GC}
- 軸6 物理レイアウト: 意味モデルの *関数*。`表示 = render(意味モデル, 面の制約, スタイル)`。意味層に入れてはいけない。 {#01KYP2JYBYK633CRHJFPMTV7GD}

[id=01KYP2JYBYK633CRHJFPMTV7GE]
3グループ化: 意味層に入れる(1,2)/入れたいが欠損しがち(3,5一部)/入れてはいけない(6, 5写真)。

## 4. 階級マップ + 物理分離(両方やる) {#01KYP2JYBYK633CRHJFPMTV7GF}

[id=01KYP2JYBYK633CRHJFPMTV7GG]
...
[id=01KYP2JYBYK633CRHJFPMTV7H4]
モチベーションに新規性5点を明記。

## 11. 型起こし(Rust) {#01KYP2JYBYK633CRHJFPMTV7H5}

[id=01KYP2JYBYK633CRHJFPMTV7H6]
...
## 12. ストア再設計(問い: SQL前提? 持ち運び微妙) {#01KYP2JYBYK633CRHJFPMTV7H7}

[id=01KYP2JYBYK633CRHJFPMTV7H8]
...
## 13. パーサ実装(TeX → MathNode) {#01KYP2JYBYK633CRHJFPMTV7HA}

[id=01KYP2JYBYK633CRHJFPMTV7HB]
...
[id=01KYP2JYBYK633CRHJFPMTV7HC]
失敗した1テストは期待エラー型の誤り(\frac{a} は ExpectedGroup が正)→ エラーを enum で型付けした配当。

## 14. アーカイブ + git 化(現在地) {#01KYP2JYBYK633CRHJFPMTV7HD}

[id=01KYP2JYBYK633CRHJFPMTV7HE]
